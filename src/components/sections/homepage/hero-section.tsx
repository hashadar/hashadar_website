...
export function HeroSection({ name, title }: HeroSectionProps) {
  ...
  return (
    ...
    >
      ...
      <Container className="relative z-10 hero-container">
        <div className="text-center space-y-12 md:space-y-16 lg:space-y-20 px-4 sm:px-6">
