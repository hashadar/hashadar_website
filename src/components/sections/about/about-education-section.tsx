...
export function AboutEducationSection({ heading, content }: AboutEducationSectionProps) {
      ...
      <Container>
        <div className="space-y-16">
          ...
          >
            ...
            <div className="absolute top-0 right-0 w-20 h-px bg-[var(--primary)] transform skew-x-12 opacity-50" />
            <div className="absolute bottom-0 left-0 w-32 h-px bg-[var(--primary)] transform -skew-x-12 opacity-30" />
            ...
            <div className="absolute top-6 left-6 w-8 h-8 border-2 border-[var(--primary)] transform -rotate-45 opacity-30" />
            <div className="absolute bottom-6 right-6 w-6 h-6 bg-[var(--primary)] transform rotate-12 opacity-10" />
          </motion.div>
        </div>
      </Container>
    </Section>
