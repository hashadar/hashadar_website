...
/**
 * Static CSS atmosphere when the home photo is missing.
 * Intentional angular composition — not an empty shell.
 */
export function HeroFallback() {
  return (
    <div
      className="pointer-events-none absolute inset-0 overflow-hidden bg-[var(--background)]"
      aria-hidden="true"
    >
      ...
      <div className="absolute inset-0 bg-gradient-to-b from-[var(--background)]/20 via-transparent to-[var(--background)]/80" />
    </div>
  );
}
