...
- **About stays biography.** Lede + experience + education + certifications. Restyle; do not rewrite as a second Statement. Home already made the argument (one practice, not a menu). Copy may be tightened; do not drop career facts or invent a new narrative spine.
...
About may reuse the Home Statement portrait. Portfolio, Blog, and Labs use the same intro without cloning Statement’s CTA or continue link.
