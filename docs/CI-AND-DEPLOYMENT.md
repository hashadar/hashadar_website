...
- **`package.json` npm overrides** pin `@opentelemetry/core`, `@opentelemetry/resources`, and `@opentelemetry/sdk-trace-base` so Amplify nested dependency trees resolve consistently. Cleanup is tracked in [#115](https://github.com/hashadar/hashadar_website/issues/115).
...
- [#115](https://github.com/hashadar/hashadar_website/issues/115) — remove or narrow `@opentelemetry/*` npm overrides
